...
import com.golnaz.kmmapplication.shared.DataEntity

class LaunchesRvAdapter(var launches: List<DataEntity>) : RecyclerView.Adapter<LaunchesRvAdapter.LaunchViewHolder>() {
    ...
    inner class LaunchViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindData(launch: DataEntity) {
            val ctx = itemView.context
            missionNameTextView.text = ctx.getString(R.string.mission_name_field, launch.title)
            launchYearTextView.text = ctx.getString(R.string.launch_year_field, launch.poster)
